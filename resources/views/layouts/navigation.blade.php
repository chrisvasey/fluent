        ...
        <div class="flex justify-between h-16">
            ...
            @guest
                <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                    ...
                    <a href="{{ route('register') }}" class="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-red-600 hover:bg-red-700"> Sign up </a>
                </div>
            @endguest
